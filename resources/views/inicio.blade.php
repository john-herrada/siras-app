...
<div class="dash-container">
    <nav class="sidebar">   
        <ul class="list-option">
            ...
            <li><a onclick="loadPage(`{{ route('puertos.index') }}`)"><i class="fa-solid fa-ethernet" style="color: rgb(255,255,255);"></i></a><span class="text-option">Direccionamiento de puertos</span></li>
            @endcan
